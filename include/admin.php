	...
	<div class="wrap">
		...
		<form action="" name="group-documents-settings-form" id="group-documents-settings-form" method="post">
		 ...
		 value="1" /></td>
				...
				<tr>
					<th><label><?php _e( 'Display File Owner', 'bp-group-documents' ); ?>:</label></th>
					<td>
		 ...
		 value="1" /></td>
				...
				<tr>
					<th><label><?php _e( 'Display File Date', 'bp-group-documents' ); ?>:</label></th>
					<td>
...
function bp_group_documents_group_add_admin_menu() {
	...
	$page = add_submenu_page(
		...
		'Buddypress Group Documents ' . __( 'Settings' ),
		'<span class="bp-group-documents-admin-menu-header">' . __( 'Buddypress Group Documents', 'bp-group-documents' ) . '</span>',
		'manage_options',
