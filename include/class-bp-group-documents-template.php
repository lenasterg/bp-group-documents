...
class BP_Group_Documents_Template {
	 ...
	 * @version 1.3 3/10/2022, check if function_exists('get_magic_quotes_gpc') cause it is deprecated in PHP > 7x
	 * v1.2.2, 3/10/2013 stergatu, sanitize_text_field, add wp_verify
	...
	public function pagination_count() {
		...
		printf( __( 'Viewing item %1$s to %2$s (of %3$s items)', 'bp-group-documents' ), $this->start_record, $this->end_record, $this->total_records );
	}
