...
function bp_group_documents_front_cssjs()
{
    ...
    if ($bp->current_component === $bp->groups->slug ) {
        ...
        wp_localize_script(
            ...
            'l10nBpGrDocuments',
            array(
            'new_category'            => esc_html__('New Category...!', 'bp-group-documents'),
            'no_file_selected'        => esc_html__('You must select a file to upload!', 'bp-group-documents'),
            'sure_to_delete_document' => esc_html__('Are you sure you wish to permanently delete this document?', 'bp-group-documents'),
            'add'                     => esc_html__('Add', 'bp-group-documents'),
            )
        );
